...
% this for QAM modulation BER by using this website concept %https://www.mathworks.com/matlabcentral/fileexchange/54223-simulation-m-qam-transmission-over-noise
% we take this dataset bucz of Monte carlo simulation   
data_source=randi([0 1],N,1); % 1 or 0 

%data_source = randi([0 1],1000*k,1);%real one
...
% ynoisy = awgn(ytx,snr,'measured');
% end
% %% Received Signal but without demodulation
% yrx = ynoisy;
% % Demodulation
% % Demodulate signal using 16-QAM.
% zsym = qamdemod(yrx,M);
...
% figure(11)
% hold on
% [errors,errorrate] = biterr(x,zsym);
% semilogy(snr,errorrate,'bs-');



%https://www.mathworks.com/matlabcentral/fileexchange/54223-simulation-m-qam-transmission-over-noise
